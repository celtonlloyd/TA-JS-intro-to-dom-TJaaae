...
a[0].textContent = 'Learning DOM';
//    - Select the first `li` element inside the `ul` with class `topics` and change the innerText to `all about document`
let b = document.body.children[5].firstElementChild;
b.textContent = 'all about document';
//    - Select the input element with name `email`
let c = document.body.children[6].children[1];
...
label = document.querySelector('legend').nextElementSibling;
...
allTopics.forEach(a =>console.log(a.innerText) )
